...
public class PrettyDateFormat2 extends SimpleDateFormat {
	 ...
	 */
	public PrettyDateFormat2(String format, String fullFormat) {
		super(fullFormat);
		init(format);
	...
	public PrettyDateFormat2(String format, String fullFormat,Locale locale) {
		super(fullFormat,locale);
		this.locale=locale;
		init(format);
		this.simpleDateFormat = new SimpleDateFormat(format.replace("'", "''"),locale);
	}
	...
	protected String getTest(String key){
		return key;
	}
}
